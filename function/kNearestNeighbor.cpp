...
const char EuclideanDisOfEachTestElementPath[] = "./data/DigitRecognizer/EuclideanDisOfEachTestElement2.txt";
const char resultPath[] = "./data/DigitRecognizer/result2.txt";
